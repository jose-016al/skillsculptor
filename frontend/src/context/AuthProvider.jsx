...
export const AuthProvider = ({ children }) => {
    ...
    const authUser = async () => {
        ...
        if (!token || !user) {
            ...
            const request = await ApiRequests(`${Global.url}user/profile/${userId}`, "GET", undefined, false, token);
    
            const data = await request.data;
    
            const requestCounters = await ApiRequests(`${Global.url}user/counters/${userId}`, "GET", undefined, false, token);
